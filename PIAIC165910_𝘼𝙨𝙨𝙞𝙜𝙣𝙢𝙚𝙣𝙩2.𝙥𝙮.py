...
# Task no 1
def function1(start, end, rows, cols):
    # create 2d array from 1,12 range 
    # dimension should be 6row 2 columns  
    # and assign this array values in x values in x variable
    # Hint: you can use arange and reshape numpy methods  
    x =  np.arange(start,end + 1).reshape((rows,cols)) 
...
# Task2
def function2(start, end, d, rows, cols):
    #create 3D array (3,3,3)
    #must data type should have float64
    #array value should be satart from 10 and end with 36 (both included)
    # Hint: dtype, reshape 
    
    x = np.arange(start,end+1,dtype=np.float64).reshape((d,rows,cols))     #wrtie your code here


    return x
functon2(10,36,3,3,3)
    """
    Expected: out put
array([[[10., 11., 12.],
        [13., 14., 15.],
...
def function3(x):
    ...
    #example [35,70,105,..]
    a = np.arange(0, 100*10+1)#.reshape((100,10))
    x = a[35::35] #wrtie your code here
    return x
function3(35)
    """
    Expected Output:
...
def function4():
    ...
    return arr.T#wrtie your code here
function4()
    """
    Expected Output:
          array([[1, 0, 2],
...
#task5
def function5(size,rows,cols):
    #Create a null vector of size 20 with 4 rows and 5 columns with numpy function
   
    z = np.zeros(size).reshape((rows,cols)) #wrtie your code here
...
def function8():
    ...
    x = np.ones((10), dtype = np.int32).reshape((2,5))#write your code here
...
def function14():
    ...
    arr = numpy.arange(10, 34+1, 1).reshape((8,3)) #write reshape code
...
def function18():
    ...
    x = students<100# Write you code Here
    return np.sum(x)
